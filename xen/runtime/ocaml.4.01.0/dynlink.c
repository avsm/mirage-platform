...
value caml_dynlink_open_lib(value mode, value filename)
{
  caml_invalid_argument("dynlink_open_lib");
  return Val_unit; /* not reached */
}

value caml_dynlink_close_lib(value handle)
{
  caml_invalid_argument("dynlink_close_lib");
  return Val_unit; /* not reached */
}

CAMLprim value caml_dynlink_lookup_symbol(value handle, value symbolname)
{
  caml_invalid_argument("dynlink_lookup_symbol");
  return Val_unit; /* not reached */
}
